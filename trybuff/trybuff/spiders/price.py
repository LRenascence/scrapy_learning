...
class PriceSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.igxe.cn/dota2/570?is_buying=0&is_stattrak%5B%5D=0&is_stattrak%5B%5D=0&price_from=50&price_to=300&sort=0&ctg_id=0&'
            'type_id=0&page_no=1&page_size=20&rarity_id=0&exterior_id=0&quality_id=0&capsule_id=0&_t=1558637222096']
    ...
    def price_parse(self, response):
        ...
        if stockNum >= 10:
            ...
            # get the steam price
            steamPriceDiv = response.css('div.proposedPrice')[1]
            # get the price
